# -*- coding: utf-8 -*-
"""
VMware Server Virtualization Documentation build configuration file.
...
rst_epilog = """
.. |service| replace:: VMware Server Virtualization
.. |no changes| replace:: None for this release
.. |contract version| replace:: <version>
.. |product name| replace:: VMware Server Virtualization
"""
...
html_title = "VMware Server Virtualization Customer Handbook"
